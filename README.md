<h1 align="center"><a href="https://baipin.pw" target="_blank">China Signs Pack</a></h1>
...
## Recommended structures 推荐路牌架
For overhead direction signs, you can use one or both of the following assets:
* [Highway Sign Frame Pack](https://mods.paradoxplaza.com/mods/127597/Any) by me. 由我制作的  
* [Highway Sign Structures](https://mods.paradoxplaza.com/mods/127499/Any) by lolok. 由 lolok制作的
  
There might be some differences for pre-layouts, but you can simply adjust manually.  
这两个路牌架可能对于模组的预制布局表现略有不同（可能刚好反过来等等），但是你可以简单地手动调整。我是根据我制作的路牌架制作该模组的预制布局的。  
